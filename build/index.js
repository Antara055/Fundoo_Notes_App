...
var _redisdb = _interopRequireDefault(require("./config/redisdb"));
...
app.use('/api-docs', _swaggerUiExpress["default"].serve, _swaggerUiExpress["default"].setup(_swagger["default"])); //app.use(morgan('combined', { stream: logStream }));
